	 ...
	 WebDriver driver = new ChromeDriver();
      ...
      for(int i=5;i<=rows;i++) {
    	//clicking on new register? link
    	  ...
    	  String subType= ExcelUtils.getCellData(filepath, "Trader1", i, 47);
    	...
    	if(ApplicantTypes.equals("Seller")) {
        	  List<WebElement>sellerTypeElement = driver.findElements(By.xpath("//div[contains(@class,'css-13sljp9')]//div[@id='sellerType']//label"));
