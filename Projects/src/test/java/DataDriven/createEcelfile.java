...
public class createEcelfile {
	public static void main(String[] args) throws IOException {
		// CREATING THE NEW FILE AND PASSING DATA INTO THE ROWS AND CELLS
	FileOutputStream file= new FileOutputStream(System.getProperty("user.dir")+"\\testdata\\TRADER.xlsx");
	XSSFWorkbook workbook = new XSSFWorkbook();
	
	XSSFSheet sheet=workbook.createSheet("Trader1");
