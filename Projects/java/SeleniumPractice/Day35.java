...
//String rowsizearr[]=new String[rowsize];
//for(int r=1; r<=rowsize; r++)
//{
//	String pricerow = driver.findElement(By.xpath("//table[@class='table']//tbody//tr["+r+"]/td[6]")).getText();
//	//System.out.println(pricerow);
//	rowsizearr[r-1]=pricerow;
//}
//for(String priceserl:rowsizearr)
//{
//System.out.println(priceserl);
//}
//Arrays.sort(rowsizearr);
//String lowerprice=rowsizearr[0];
//System.out.println("========================" +lowerprice);
//for(int r=1; r<=rowsize;r++)
//{
//	String pricerow=driver.findElement(By.xpath("//table[@class='table']//tbody//tr["+r+"]//td[6]")).getText();
//	if(pricerow.equals(lowerprice))
//	{
...
//count the number of rows are prensent in a table
//store size of an row in an array
//getText of an price columns and adding price into array index wise
//sort tha stored array values
//print lowest value in with help of index
//using the for loop get all price text and 
// use if condtion with equales method
//if it is true click on the file.